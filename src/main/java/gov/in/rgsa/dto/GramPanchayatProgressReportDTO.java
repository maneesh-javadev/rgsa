...
@NamedNativeQuery(name="FETCH_GRAM_PANCHAYAT_REPORT_DETAILS",query="SELECT t.panhcayat_bhawan_activity_id, t.id as panhcayat_bhawan_activity_details_id, t.district_code,t.local_body_code,"
		...
		+ "LEFT OUTER JOIN rgsa.panhcayat_bhawan_activity_gps dg ON (d.id  = dg.panhcayat_bhawan_activity_details_id and dg.isactive) WHERE d.activity_id=:activityId and d.panhcayat_bhawan_activity_id =:panchayatBhawanActivityId  and "
