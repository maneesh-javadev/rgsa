...
@NamedQueries({
	...
	@NamedQuery(name="FETCH_STATE_ALLOCATION_BY_COMP_ID_AND_SUBCOMPID_AND_INSTALL_NO",query="from StateAllocation where componentId=:componentId and installmentNo=:installmentNo and subcomponentId=:subComponentId and fundsAllocated is not null and fundsAllocated != 0"),
