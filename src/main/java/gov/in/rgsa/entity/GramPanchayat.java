...
@NamedNativeQueries({
		/*
		 * @NamedNativeQuery(name="GRAM_PANCHAYAT_LGD",
		 * query="select entity_code,entity_name,entity_local_name from lgd.get_districtwise_assigned_unit(:districtCode) where entity_type='G' and entity_subtype=3 order by entity_name"
		 * ),
		 */
	@NamedNativeQuery(name="GRAM_PANCHAYAT_LGD",query="select entity_code,entity_name,entity_local_name from lgd.get_districtwise_assigned_unit(:districtCode) where entity_type='G'  order by entity_name"),
