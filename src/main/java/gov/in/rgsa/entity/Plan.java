...
@Entity
@NamedQueries({
	@NamedQuery(name="CURRENT_PLAN_STATUS_BY_PLANCODE",query="from Plan where planCode=:planCode and planStatusId=:planStatusId and yearId=:yearId and isactive=true"),
...
public class Plan implements Serializable ,Comparable<Plan>{
	...
	public int compareTo(Plan arg0)
	{
		...
		return stateName.compareTo(arg0.getStateName());
	}
