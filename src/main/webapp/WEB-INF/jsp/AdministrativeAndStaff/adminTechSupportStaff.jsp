					...
					<div class="body">
						...
						<div class="form-group text-right">
						 <c:if test="${Plan_Status eq true}"> 
							...
							<button data-ng-click="saveData('F')" data-ng-if='adminTechStaffObject.status == "S" || btn_disabled  || adminTechStaffObject.status == "U"' type="button" class="btn bg-orange waves-effect">FREEZE</button>
