...
function removeDisabledAttr(status){
...
$( document ).ready(function() {
	...
	if($("#data2_state").val() != ""){
		...
		if(total_population>0){
			...
			if(population_20>0){
				/* women_percent= (population_20/total_population) * 100; */
	...
	$("#data5_state,#data6_state,#data20_state,#data9_bp,#data14_gp,#data14_bp,#data14_dp,#data15_gp,#data15_bp,#data9_dp,#data7_state,#data8_state,#data13_gp,#data13_bp,#data13_dp,#data10_state,#data11_state,#data27_gp,#data27_bp,#data45_bp,#data45_gp,#data45_state,#data30_gp,#data30_bp,#data31_gp,#data31_bp,#data32_bp,#data32_gp,#data33_gp,#data9_gp,#data48_bp,#data48_gp,#data11_dp,#data11_bp,#data11_gp,#data34_gp1,#data34_gp2,#data34_bp1,#data34_bp2,#data34_dp1,#data34_dp2,#data34_gp_count,#data34_bp_count,#data34_dp_count").change(function() {
		...
		if((stateCode != 11 && (stateCode !=14 && stateCode != 25)) && (stateCode != 26 && (stateCode != 30 && stateCode != 31))){
			...
			data9_gp=$_checkEmptyObject_value($("#data9_gp").val());
			data9_dp=$_checkEmptyObject_value($("#data9_dp").val());
			if(data9_dp > 0 && data9_dp > data9_gp){
				alert("Value Should be Greater than District Panchayat");
				$("#data9_gp").val(' ');
			}
		}
		...
		/* else{
			alert("Please enter Autonomous District Councils (ADCs) value");
			$(this).val(' ');
		} */
		...
		/* 		data45_gp=$_checkEmptyObject_value($("#data45_gp").val());	
			...
			if(data9_gp>0 && data34_gp_count > data9_gp){
				alert("Value Should be less than of total no of Garam Panchayat of State");
				$("#data34_gp_count").val(' ');
			}
