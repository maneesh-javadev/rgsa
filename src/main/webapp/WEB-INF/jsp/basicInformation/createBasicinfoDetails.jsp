				                                     ...
				                                     <div class="form-group form-float">&nbsp;&nbsp;&nbsp;
				                                        <div class="form-line">
				                                           ...
				                                           GP Bhawan with toilet facility
				                                              ...
				                                              <c:if test="${field.basicInfoDefinationDetailsId eq 32}">
				                                            ...
				                                            && field.basicInfoDefinationDetailsId ne 31 && field.basicInfoDefinationDetailsId ne 45    && field.basicInfoDefinationDetailsId ne 32}">
				                                            Gram Panchayat
				                                            </c:if>
				                                            </label>
				                                        </div>
