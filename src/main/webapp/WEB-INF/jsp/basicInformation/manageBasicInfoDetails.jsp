                        ...
                        <div class="body">
                        	<c:if test="${empty BASIC_INFO}">
	                         <div class="form-group text-right">
	                            	<a href="basicinfo.html?<csrf:token uri='basicinfo.html'/>" class="btn bg-green waves-effect"> ADD BASIC INFO</a>
	                         </div>
	                         </c:if>
	                                        ...
	                                        <c:choose>
	                                        	<c:when test="${!empty BASIC_INFO}">
	                                        		<tr>
			                                           ...
			                                           <!--  <td>
			                                      			<span><a href="viewBasicInfoDetails.html"><i class="fa fa-eye fa-lg view-color" aria-hidden="true"></i></a></span> 
			                                            </td> -->
			                                            <td>
			                                            	<span><a href="updateBasicInfoDetails.html"><i class="fa fa-pencil-square-o fa-lg edit-color" aria-hidden="true"></i></a></span>
			                                            </td>
			                                            <%-- <td>
			                                            	<span><a href="freezeBasicInfoDetails.html?basicInfoId=${BASIC_INFO.basicInfoId}"><i class="fa fa-lock fa-lg delete-color" aria-hidden="true"></i></a></span>	
			                                            </td> --%>
			                                        </tr>	
	                                        	</c:when>
	                                        	<c:otherwise>
	                                        		<tr><td class="text-center" colspan="5"><b class="delete-color">
	                                        			<i class="fa fa-smile-o" aria-hidden="true"></i> You Have not added basic information</b>
	                                        		</td></tr>
	                                        	</c:otherwise>
	                                        </c:choose>
                                    </tbody> 
