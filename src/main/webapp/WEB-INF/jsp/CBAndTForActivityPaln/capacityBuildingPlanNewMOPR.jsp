							...
							<div class="records">
								<div class="table-responsive">
									<table id="trainingActivityTblId"
										...
										<td align="right"><input type="text" data-ng-disabled="fetchTrainingMOPR.isFreeze" data-ng-change="calculateFund('P',$index)" data-ng-model="training.trainingDetailList[$index].noOfParticipants" onkeypress="return isNumber(event)" required="required"  class="form-control element-width" maxlength="8" style="text-align:right;"> </td>
