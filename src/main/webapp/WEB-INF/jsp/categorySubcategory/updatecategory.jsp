		...
		<div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<div class="header">
						<h2>
							<spring:message code="Label.UpdateSubCategory" htmlEscape="true" />
						</h2>
					</div>
					<form:form method="POST" id="categorySubcategoryId"
						action="updateCategory.html" modelAttribute="CATEGORY_SUBCATEGORY"
						path="categorySubcategory">
						<input type="hidden" name="<csrf:token-name/>"
							value="<csrf:token-value uri="updateCategory.html"/>" />
