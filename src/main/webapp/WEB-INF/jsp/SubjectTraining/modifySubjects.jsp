		...
		<div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					...
					<form:form method="post" id="modifySubjectsId"
						action="modifysubjects.html" modelAttribute="SUBJECT_TRAINING_MODEL">
						<input type="hidden" name="<csrf:token-name/>"
							value="<csrf:token-value uri="modifysubjects.html"/>" />
							...
							<div class="row clearfix">
								<div class="col-sm-6">
									...
									<div class="form-group">
										<div class="form-line">
											<form:select path="trainingCtgId" class="form-control show-tick">
