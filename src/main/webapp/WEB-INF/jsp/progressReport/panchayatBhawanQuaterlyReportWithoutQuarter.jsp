...
<%@include file="panchayatBhawanQuaterlyReportWithoutQuarterJs.jsp"%>
						...
						<div class="body">
							<div class="card">
								<form:form method="POST" name="qprPanchayatBhawan" action="saveQprPanchayatBhawanData1.html" modelAttribute="QPR_PANCHAYAT_BHAWAN" enctype="multipart/form-data" >
									...
									<input type="hidden" name="qtrId"  id="qtrId" value="0"/>
									...
									<span class="" ><c:out value='${msg}' /></span>
											...
											<table class="table table-bordered table-striped table-hover" >
												...
												<tbody>
													...
													<c:set var="count_length" value="0"/>
														...
														<input type="hidden" id="panchayat_bhawan_count_length" value="${count_length}"/>
													</c:if>
												</tbody>
											</table>
										...
										<c:if test="${isExistQprPanchayatBhawan}">
											<form:button type="button" class="btn bg-green waves-effect" disabled="${QPR_PANCHAYAT_BHAWAN.isFreeze}" onclick="save_data()" id="savebtn">
												Save</form:button>
										<c:choose>
