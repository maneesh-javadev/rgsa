...
function validateWithCorrespondingFund(){
	...
	if($('#expenditureIncurred').val() > tota_fund_cec){
						...
						<div class="body">
							<div class="table-responsive" id="tableDivId">
								...
								<div class="text-right">
									<form:button type="button" onclick="saveAndGetDataQtrRprt('save')" id="iec_save" disabled="${IEC_ACTIVITY_PROGRESS.isFreeze}"
