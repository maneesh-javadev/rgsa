...
function validateAddReq(){
	//var remaining_add_req_new=$('#additionalReqStateId').val();
	...
	<div class="container-fluid">
		<div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<div class="header">
						<h2>Income Enhancement Withput Quarter Progress Report</h2>
					
					 <form:form method="POST" id="incomeEnhancementId"	name="incomeEnhancement" class="form-inline"
						action="incomeEnhancementQuaterly.html"	modelAttribute="QPR_INCOME_ENHANCEMENT_WITHOUT_QUATER">
