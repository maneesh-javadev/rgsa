...
function save_data()
{
	var length=$("#panchayat_bhawan_count_length").val();
	var flag=true;
	for(var i=0;i<length;i++)
		{
		if($("#gpBhawanStatusId_"+i).val()!=0)
			{
	...
	if(flag){
		disabled_button();
		document.qprPanchayatBhawan.method = "post";
		document.qprPanchayatBhawan.action = "saveQprPanchayatBhawanData1.html.html?<csrf:token uri='saveQprPanchayatBhawanData1.html.html'/>";
		document.qprPanchayatBhawan.submit();
	}
	else
	{
