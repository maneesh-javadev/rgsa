...
<%@include file="../progressReport/trainingDetailsProgressReportWithoutQuarterJs.jsp"%>
                           ...
                           <table id="trainingActivityTblId" class="table table-hover dashboard-task-infos">
							 ...
							 <c:set var="count_length" value="0"/>
                              ...
                              <c:set var="count_length" value="${count.index+1}"/>
								...
								<input type="hidden" id="training_details_count_length" value="${count_length}"/>
                           		<tr>
									...
									<div class="modal-dialog modal-lg">
										...
										<div class="modal-content">
											...
											<div class="modal-footer">
												<button type="button" onclick="save_data('modalSave')" id="modalSavebtn" class="btn btn-success">Save</button>
