...
function saveAndGetDataQtrRprt(msg){
	var length=$("#satcom_count_length").val();
	var flag=true;
		...
		<div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					...
					<form:form method="post" name="satcomActivityProgress" action="currentUsageSatcomQuaterlyPost.html" modelAttribute="SATCOM_WITHOUT_QUATER">
					...
					<div class="body">
							...
							<table class="table table-bordered">
								...
								<c:set var="count_length" value="0"/>
									...
									<input type="hidden" id="satcom_count_length" value="${count_length}"/>
									<tr>
						...
						<!--hidden fields  -->
						<input type="hidden" id="qtrId" name="qtrIdJsp1" value="0"/> 
					    ...
					    <input type="hidden" id="quaterDropDownId" name="satcomActivityProgressDetails[0].quarterDuration.qtrId" value="0" />
