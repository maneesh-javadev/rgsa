...
<%@include file="institutionalInfraQuaterlyReportNewJsWithoutQuarter.jsp"%>
			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<input type="hidden" name="qprInstInfraId" value="${QPR_INSTITUTIONALINFRAQUATERLY.qprInstInfraId}" id="qprInstInfraId" />
						...
						<div class="row" >
							<input type="hidden" id="qtrId" name="qtrId" value="0">
						</div>	 
					   ...
					   <c:if test="${installementExist}">
						...
						<tr>
								...
								<td align="center">
									<%-- disabled="${QPR_INSTITUTIONALINFRAQUATERLY.isFreeze}" --%>
											...
											<select id="nsInstInfraStatusId${nsindex}"
						...
						<tr>
								...
								<td align="center">
											...
											<form:select id="nsInstInfraStatusId${nsindex}" name="qprInstitutionalInfraNewSprc[${nsindex}].instInfraStatusId"
								...
								<td align="center">
												...
												<input id="nbs_${sindex}" onkeypress="return isNumber(event)" name="qprInstitutionalInfraNewSprc[${nsindex}].expenditureIncurred"  class="form-control"  
										maxlength="8" style="text-align:right;" required="required" autocomplete="off" onblur="validate_expenditureIncurred('${sprcBalAmount}',this,'${bhawanDto.totalFundApproved}')" />
						...
						<input type="file" id="file"  name="qprInstitutionalInfraNewSprc[${nsindex}].file"/>		
								...
								<input type="hidden" id="ns_inst_count_length" value="${ns_count_length}"/>
                           		<tr>
                           ...
                           <div  class="col-lg-12 sub_head">
							...
							<%-- 	<c:if test="${bhawanDto.workType eq 'N' and bhawanDto.institutionalActivityTypeId==4}"> --%>
                       		...
                       		<tr>
								...
								<td align="center">
											<form:select id="ndInstInfraStatusId${ndindex}" name ="qprInstitutionalInfraNewDprc[${ndindex}].instInfraStatusId"
                       		...
                       		<tr>
								...
								<td align="center">
											...
											<select id="ndInstInfraStatusId${ndindex}" name="qprInstitutionalInfraNewDprc[${ndindex}].instInfraStatusId"
											 class="form-control"   >
								 			<option value="0">Select Status</option>
											<c:forEach items="${InstInfraStatus}" var="obj">
												<c:if test="${obj.trainingInstitueType.trainingInstitueTypeId==bhawanDto.institutionalActivityTypeId }">
								...
								<input type="hidden" id="nd_inst_count_length" value="${nd_count_length}"/>
								<tr>
					...
					<div class="records">
                           ...
                           <table id="trainingActivityTblId"
                             ...
                             <thead>
                              ...
                              <tbody id="tbodyIdCsprc">
                                  ...
                                  <c:set var="cs_count_length" value="0"/>
                                <c:forEach items="${instInfraStateDataForProgressReport}" var="bhawanDto" varStatus="count">
                                <c:set var="cs_count_length" value="${count.index+1}"/>
						...
						<tr>
								...
								<td align="center">
									<%-- disabled="${QPR_INSTITUTIONALINFRAQUATERLY.isFreeze}" --%>
											<select id="csInstInfraStatusId${csindex}"
						...
						<tr>
								...
								<td align="center">
											...
											<form:select id="csInstInfraStatusId${csindex}" name="qprInstitutionalInfraCarrySprc[${csindex}].instInfraStatusId"
											 class="form-control"  path="${status.expression}" disabled="${QPR_INSTITUTIONALINFRAQUATERLY.isFreeze}" >
								 			<option value="0">Select Status</option>
											<c:forEach items="${InstInfraStatus}" var="obj">
												<c:if test="${obj.trainingInstitueType.trainingInstitueTypeId==bhawanDto.institutionalActivityTypeId }">
							...
							<input type="file" id="file"  name="qprInstitutionalInfraCarrySprc[${csindex}].file"/>	
								...
								<input type="hidden" id="cs_inst_count_length" value="${cs_count_length}"/>
								<tr>
									<td colspan="4">
										<strong>
											<spring:message code="Label.TotalProposedFund" htmlEscape="true" /> (SPRC)
						...
						<div class="records">
                        	<div class="">
                             ...
                             <thead>
                              ...
                              <tbody id="tbodyId">
                                   <c:set var="cd_count_length" value="0"/>
									<c:forEach items="${instInfraStateDataForProgressReport}" var="bhawanDto" varStatus="count">
                       		<c:set var="cd_count_length" value="${count.index+1}"/>
                       		...
                       		<tr>
								...
								<td align="center">
											<form:select id="cdInstInfraStatusId${cdindex}" name ="qprInstitutionalInfraCarryDprc[${cdindex}].instInfraStatusId"
											 class="form-control xxx"  path="${status.expression}" disabled="${QPR_INSTITUTIONALINFRAQUATERLY.isFreeze}">
								 			<option value="0">Select Status</option>
											<c:forEach items="${InstInfraStatus}" var="obj">
												<c:if test="${obj.trainingInstitueType.trainingInstitueTypeId==bhawanDto.institutionalActivityTypeId }">
                       		...
                       		<tr>
								...
								<td align="center">
											...
											<select id="cdInstInfraStatusId${cdindex}" name="qprInstitutionalInfraCarryDprc[${cdindex}].instInfraStatusId"
											 class="form-control"   >
								 			<option value="0">Select Status</option>
											<c:forEach items="${InstInfraStatus}" var="obj">
												<c:if test="${obj.trainingInstitueType.trainingInstitueTypeId==bhawanDto.institutionalActivityTypeId }">
						       ...
						       <input type="file" id="file"  name="qprInstitutionalInfraCarryDprc[${cdindex}].file"/>			
								...
								<input type="hidden" id="cd_inst_count_length" value="${cd_count_length}"/>
								<tr>
									<td colspan="4">
										<strong>
											<spring:message code="Label.TotalProposedFund" htmlEscape="true" /> (DPRC)
