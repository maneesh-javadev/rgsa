					...
					<div class="card">
						...
						<table class="table table-hover dashboard-task-infos">
							...
							<%-- <c:if test="${sessionScope['scopedTarget.userPreference'].userType eq 'M'}"> --%>
										...
										<c:if test="${buttonStatus}">
											<c:choose>
												<c:when test="${not forwardPlanStatus or not isallCompVerify}"><input type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal" value="Forward Plan To CEC"/></c:when>
												<c:when test="${forwardPlanStatus and isallCompVerify}">
													<c:if test="${isShowForwardButton}">
														<input type="button" class="btn bg-light-blue" data-ng-click="forwardPlan(${forwardPlanStatus})" value="Forward Plan To CEC" ng-show="showBtn"/>
												   </c:if>
												</c:when>
							...
							<input type="button" style="float: right;" class="btn bg-red waves-effect" data-ng-click="revertPlan(${stateCode});" value="Revert Plan To ${stateName}" ng-show="showBtn">
							</c:if>
							</div>
