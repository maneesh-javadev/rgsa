					...
					<div class="card">
                        ...
                        <div class="">
                           ...
                           <div class="row">
								...
								<div class="col-lg-4">
									<label><spring:message code="Label.District" htmlEscape="true" /></label>
								</div>
								<div class="col-lg-4">
                           ...
                           <table id="trainingActivityTblId"
                             ...
                             <thead>
                              ...
                              <tfoot>
                                 			<tr>
												<td colspan="4"><strong><spring:message code="Label.SubTotal" htmlEscape="true" />(SPRC)</strong></td>
												<td>
											...
											<tr>
												<td colspan="4"><strong><spring:message code="Label.AdditionalRequirement" htmlEscape="true" /> (SPRC)</strong></td>
												<td>
											...
											<tr>
												<td colspan="4"><strong><spring:message code="Label.TotalProposedFund" htmlEscape="true" /> (SPRC)</strong></td>
												<td>
                           ...
                           <div class="row">
                            ...
                            <table id="trainingActivityTblId"
                             ...
                             <thead>
                              ...
                              <tfoot>
                                 			<tr>
												<td colspan="4"><strong><spring:message code="Label.SubTotal" htmlEscape="true" />(DPRC)</strong></td>
												<td>
											...
											<tr>
												<td colspan="4"><strong><spring:message code="Label.AdditionalRequirement" htmlEscape="true" /> (DPRC)</strong></td>
												<td>
											...
											<tr>
												<td colspan="4"><strong><spring:message code="Label.TotalProposedFund" htmlEscape="true" /> (DPRC)</strong></td>
												<td>
                           ...
                           <table id="trainingActivityTblId"
                             ...
                             <thead>
                              ...
                              <tfoot>
											...
											<tr>
												<td colspan="5"><strong><spring:message code="Label.TotalProposedFund" htmlEscape="true" /> (SPRC)</strong></td>
												<td>
                           ...
                           <table id="trainingActivityTblId"
                             ...
                             <thead>
                              ...
                              <tfoot>
											...
											<tr>
												<td colspan="5"><strong><spring:message code="Label.TotalProposedFund" htmlEscape="true" /> (DPRC)</strong></td>
												<td>
